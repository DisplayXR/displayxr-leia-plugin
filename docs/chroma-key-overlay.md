...
The same lifecycle is implemented in three places that share the same shader source — these live in the **runtime repo** ([displayxr-runtime](https://github.com/DisplayXR/displayxr-runtime)), not here:
