                   ...
                   struct xrt_display_processor **out_xdp)
{
	...
	// absolute path, so there is nothing to front-run. Preloading the legacy DLL
	// here would additionally leave a pre-stamp weaver resident on machines that
	// must use the stamp-aware one.
